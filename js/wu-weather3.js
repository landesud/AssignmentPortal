...
weatherObject.open('GET','http://api.wunderground.com/api/8e74e5070463a375/conditions/q/MO/Springfield.json', true);
...
weatherDesc.open('GET','http://api.wunderground.com/api/8e74e5070463a375/forecast/q/MO/Springfield.json', true);
